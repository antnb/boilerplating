...
import { checkArticleSlugExists, getArticleBySlug, getAllArticleSlugs } from "@/lib/data/articles";
import ArticleDetailClient from "@/components/knowledge/article/ArticleDetailClient";
